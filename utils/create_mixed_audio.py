...
def create_mixed_audios(args):
    ...
    # Paths
    mixture_yaml_path = os.path.join(workspace, 'yaml_files', mixture_type, 'mixture.yaml')
    ...
    for n, data in enumerate(data_list):
        ...
        for event in data['events']:
            ...
            events_audio[onset:offset] = event_audio[0:min(offset-onset, 320000-onset)]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--mixture_type', type=str,
