...
if __name__ == '__main__':
    ...
    parser_single_fold.add_argument('--model_type', type=str,
                              choices=['gwrp', 'rgwrp', 'tp',
                                       'unet', 'runet', 'tunet',
                                       'hornnet', 'rhornnet', 'thornnet'], required=True)
    parser_single_fold.add_argument('--mixture_type', type=str,
    ...
    parser_all_folds.add_argument('--model_type', type=str,
                              choices=['gwrp', 'rgwrp', 'tp',
                                       'unet', 'runet', 'tunet',
                                       'hornnet', 'rhornnet', 'thornnet'], required=True)
    parser_all_folds.add_argument('--mixture_type', type=str,
                              choices=['original', 'rand_init', 'no_clip', 'mix'], required=True)
